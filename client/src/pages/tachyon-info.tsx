...
export default function TachyonInfo() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-cosmic-950 via-mystical-900 to-cosmic-950">
      {/* Navigation */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-cosmic-950/80 backdrop-blur-sm border-b border-cosmic-800/20">
      ...
      <div className="pt-24 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-cinzel font-bold text-[#feffff] mb-4">
              Tachyon Chamber
            </h1>
            <p className="text-xl text-gold-400 font-cinzel">
          ...
          <div className="space-y-12">
            ...
            <section className="bg-cosmic-900/40 backdrop-blur-sm rounded-lg p-8 border border-cosmic-800/20">
              <h2 className="text-2xl font-cinzel font-bold text-gold-400 mb-6 flex items-center">
                <span className="text-mystical-400 mr-3">✧</span>
                Introduction to Tachyons
              </h2>
              <p className="text-[#feffff] leading-relaxed mb-4">
            ...
            <section className="bg-cosmic-900/40 backdrop-blur-sm rounded-lg p-8 border border-cosmic-800/20">
              ...
              <p className="text-[#feffff] leading-relaxed">
            ...
            <section className="bg-cosmic-900/40 backdrop-blur-sm rounded-lg p-8 border border-cosmic-800/20">
              ...
              <ul className="text-[#feffff] space-y-2 ml-6 mb-4">
            ...
            <section className="bg-cosmic-900/40 backdrop-blur-sm rounded-lg p-8 border border-cosmic-800/20">
              ...
              <ul className="text-[#feffff] space-y-2 ml-6 mb-6">
                <li className="flex items-start">
                  <span className="text-mystical-400 mr-2">•</span>
              ...
              <div className="grid md:grid-cols-2 gap-4 mb-6">
                <ul className="text-[#feffff] space-y-2">
                  <li className="flex items-start">
                    <span className="text-mystical-400 mr-2">•</span>
            ...
            <section className="bg-cosmic-900/40 backdrop-blur-sm rounded-lg p-8 border border-cosmic-800/20">
              ...
              <ul className="text-[#feffff] space-y-3 mb-6">
                <li className="flex items-start">
                  <span className="text-mystical-400 mr-2">•</span>
              ...
              <p className="text-[#feffff] leading-relaxed mb-6">
              ...
              <div className="bg-cosmic-800/20 rounded-lg p-6 border border-cosmic-700/20">
            ...
            <section className="bg-cosmic-900/40 backdrop-blur-sm rounded-lg p-8 border border-cosmic-800/20">
              ...
              <ul className="text-[#feffff] space-y-2 ml-6 mb-8">
                <li className="flex items-start">
                  <span className="text-mystical-400 mr-2">•</span>
